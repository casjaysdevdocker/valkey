...
# @@License          :  LICENSE.md
# @@ReadME           :  valkey.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Jun 19, 2024 10:26 EDT
# @@File             :  valkey.sh
# @@Description      :
...
DATABASE_DIR="${DATABASE_DIR_VALKEY:-/data/db/sqlite}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set webroot
WWW_ROOT_DIR="/usr/share/httpd/default"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Default predefined variables
DATA_DIR="/data/valkey"   # set data directory
CONF_DIR="/config/valkey" # set config directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the containers etc directory
ETC_DIR="/etc/valkey"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/valkey"
RUN_DIR="/run/valkey"       # set scripts pid dir
LOG_DIR="/data/logs/valkey" # set log directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
...
root_user_name="${VALKEY_ROOT_USER_NAME:-}" # root user name
root_user_pass="${VALKEY_ROOT_PASS_WORD:-}" # root user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
user_name="${VALKEY_USER_NAME:-}"      # normal user name
user_pass="${VALKEY_USER_PASS_WORD:-}" # normal user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
SERVICE_USER="valkey"  # execute command as another user
SERVICE_GROUP="valkey" # Set the service group
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
EXEC_CMD_BIN='valkey-server ' # command to execute
...
[ -f "$CONF_DIR/env/valkey.script.sh" ] && . "$CONF_DIR/env/valkey.script.sh" # Generated by my dockermgr script
[ -f "$CONF_DIR/env/valkey.sh" ] && . "$CONF_DIR/env/valkey.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
APPLICATION_FILES="$LOG_DIR/valkey.log"
...
__update_conf_files() {
  ...
  # replace variables
  # __replace "" "" "$CONF_DIR/valkey.conf"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# root/admin user info [password/random]
#ENV_ROOT_USER_NAME="${ENV_ROOT_USER_NAME:-$VALKEY_ROOT_USER_NAME}"   # root user name
#ENV_ROOT_USER_PASS="${ENV_ROOT_USER_NAME:-$VALKEY_ROOT_PASS_WORD}"   # root user password
#root_user_name="${ENV_ROOT_USER_NAME:-$root_user_name}"                              #
#root_user_pass="${ENV_ROOT_USER_PASS:-$root_user_pass}"                              #
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#Normal user info [password/random]
#ENV_USER_NAME="${ENV_USER_NAME:-$VALKEY_USER_NAME}"                  #
#ENV_USER_PASS="${ENV_USER_PASS:-$VALKEY_USER_PASS_WORD}"             #
