...
# set data directory
DATA_DIR="/data/valkey"
# set config directory
CONF_DIR="/config/valkey"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# root user name
root_user_name="${VALKEY_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${VALKEY_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${VALKEY_USER_NAME:-}"
# normal user password
user_pass="${VALKEY_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "$CONF_DIR/env/valkey.script.sh" ] && . "$CONF_DIR/env/valkey.script.sh"
# Overwrite the variabes
[ -f "$CONF_DIR/env/valkey.sh" ] && . "$CONF_DIR/env/valkey.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
